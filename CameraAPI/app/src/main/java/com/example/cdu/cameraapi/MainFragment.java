...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       fm = getChildFragmentManager();
        ...
        Button startTakingPhotosButton = (Button) view.findViewById(R.id.startTakingPhotos);

        startTakingPhotosButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                int hasPermission = ContextCompat.checkSelfPermission(getContext(), Manifest.permission.CAMERA);
                Log.i("******" + hasPermission, "****" + PackageManager.PERMISSION_GRANTED);
